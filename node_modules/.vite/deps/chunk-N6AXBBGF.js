...
var imageBlockSchema = fe("image-block", () => {
  return {
    inline: false,
    group: "block",
    selectable: true,
...
var remarkImageBlockPlugin = ke("remark-image-block", () => () => visitImage);
...
var imageBlockConfig = h(defaultImageBlockConfig, "imageBlockConfigCtx");
...
function useBlockEffect({
  ...
  useEffect(() => {
    ...
    const onMove = (e) => {
      ...
      imageRef.dataset.height = h2;
      imageRef.style.height = `${h2}px`;
    };
    const pointerUp = () => {
    ...
    const onLoad = (e) => {
      ...
      const h2 = (transformedHeight * ratio).toFixed(2);
...
var imageBlockView = le(imageBlockSchema.node, (ctx) => {
...
//# sourceMappingURL=chunk-N6AXBBGF.js.map
