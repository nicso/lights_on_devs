...
var codeBlockConfig = h(defaultConfig, "codeBlockConfigCtx");
...
var codeComponent = ({
  ...
  return html`<host class=${clsx_default(selected && "selected")}>
    ...
    <div class="codemirror-host">${h2(codemirror == null ? void 0 : codemirror.dom, {})}</div>
  </host>`;
};
codeComponent.props = {
  selected: Boolean,
...
function history(config = {}) {
  return [
    ...
    EditorView.domEventHandlers({
      beforeinput(e, view) {
        let command2 = e.inputType == "historyUndo" ? undo2 : e.inputType == "historyRedo" ? redo2 : null;
        if (!command2)
          return false;
        e.preventDefault();
...
// node_modules/@milkdown/crepe/lib/esm/index-I5dm1KsK.js
var defineFeature = (editor, config = {}) => {
  editor.config(async (ctx) => {
    ...
    if (!languages) {
      const { languages: langList } = await import("./dist-YYUX3YFT.js");
      languages = langList;
    }
    if (!theme) {
      const { oneDark } = await import("./dist-ZAHIAX3L.js");
      theme = oneDark;
    }
...
//# sourceMappingURL=index-I5dm1KsK-ASVM6NWO.js.map
