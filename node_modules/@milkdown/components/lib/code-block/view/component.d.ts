...
export declare const CodeElement: import("atomico/types/dom").Atomico<CodeComponentProps | (CodeComponentProps & import("atomico/types/component").SyntheticMetaProps<any>), {
    new (): HTMLElement;
