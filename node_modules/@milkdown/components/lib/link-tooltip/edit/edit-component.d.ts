...
export declare const LinkEditElement: import("atomico/types/dom").Atomico<LinkEditProps | (LinkEditProps & import("atomico/types/component").SyntheticMetaProps<any>), {
    new (): HTMLElement;
