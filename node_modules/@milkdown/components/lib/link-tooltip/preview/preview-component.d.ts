...
export declare const LinkPreviewElement: import("atomico/types/dom").Atomico<LinkPreviewProps | (LinkPreviewProps & import("atomico/types/component").SyntheticMetaProps<any>), {
    new (): HTMLElement;
