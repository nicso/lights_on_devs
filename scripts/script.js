...
//region fake Bd
let user1 = new User("user 1", "https://loremflickr.com/50/50?random=1");
let user2 = new User("user 2", "https://loremflickr.com/50/50?random=1");
let user3 = new User("user 3", "https://loremflickr.com/50/50?random=1");
let user4 = new User("user 4", "https://loremflickr.com/50/50?random=1");
...
function addSpotlightElement(element, i){
    ...
    image.src = "https://loremflickr.com/450/270/cat,dog?random=" + i;
